...
* RStudio IDE (v. 2025.09.0+387), if RStudio IDE is used to compile the PDF (see below)
* R packages:
  * `stats (v. 4.5.1)`
  * `knitr (v. 1.50)`
  * `bookdown (v. 0.43)`
